...
keys = {'SMART_VERT': [{'label': 'Merge Last', 'keymap': 'Mesh', 'idname': 'machin3.smart_vert', 'type': 'ONE', 'value': 'PRESS', 'properties': [('mode', 'MERGE'), ('mergetype', 'LAST'), ('slideoverride', False)]},
        ...
        'ASSETBROWSER': [{'label': 'Bookmark 1', 'keymap': 'File Browser', 'space_type': 'FILE_BROWSER', 'idname': 'machin3.assetbrowser_bookmark', 'type': 'ONE', 'value': 'PRESS', 'alt': True, 'properties': [('index', 1)]},
                         ...
                         {'label': 'Bookmark 0', 'keymap': 'File Browser', 'space_type': 'FILE_BROWSER', 'idname': 'machin3.assetbrowser_bookmark', 'type': 'ZERO', 'value': 'PRESS', 'alt': True, 'properties': [('index', 10)]}],
