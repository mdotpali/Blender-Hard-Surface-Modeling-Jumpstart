    ...
    def draw_object_box(self, context, active, view, layout):
        ...
        if active.type == "MESH":
            ...
            if bpy.app.version >= (4, 1, 0):
                ...
                if r.active:
                    r.prop(mod, '["Input_1"]', text="Auto Smooth Angle")  # see https://blender.stackexchange.com/questions/222535/how-to-draw-inputs-from-geometry-nodes-modifier-in-a-panel and the following comment below as well
                else:
